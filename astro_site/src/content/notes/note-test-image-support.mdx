...
draft: false
tags: ["feature", "images"]
featuredImage: ./images/example-photo-iphone.jpg
---
...
![Example Image demonstrating image support in notes](./images/example-image.svg)

Use Astro's optimized image processing by storing images in `/src/content/notes/images/` and referencing them with relative paths in markdown.
...
The featured image should be stored in the same directory as your note content (e.g., `/src/content/notes/images/`) for content collection images, or use relative paths to images in `/src/content/notes/images/` for markdown content. 
